...
// Функция для входа
function войти() {
    const почта = document.getElementById("Электронная почта").value;
...
function зарегистрировать() {
    const новоеИмя = document.getElementById("Имя").value;
    const новаяПочта = document.getElementById("Электронная почта").value;
    const новыйПароль = document.getElementById("Пароль").value;

    // Создаем нового пользователя
    const новыйПользователь = new Пользователь(новаяПочта, новыйПароль, новоеИмя); // Передаем правильные значения
    ...
    document.getElementById("Пароль").value = "";
...
function показатьСтатью(статья) {
    ...
    страница.innerHTML = `
        ...
        <button onclick="вернутьсяНаГлавнуюСтраницу()">Назад</button> <!-- Вот здесь добавлена кнопка -->
    `;
...
пользователи.push(new Пользователи("логин", "password", "name"));
